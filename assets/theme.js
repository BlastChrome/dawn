((i) => {
  ...
  (o = 0),
        ...
        !0 === o.options.infinite
          ? (o.slideCount > o.options.slidesToShow &&
              ...
              !0 === o.options.vertical &&
                ...
                (2 === o.options.slidesToShow ? (t = -1.5) : 1 === o.options.slidesToShow && (t = -2)),
          ...
          : i + o.options.slidesToShow > o.slideCount &&
            ((o.slideOffset = (i + o.options.slidesToShow - o.slideCount) * o.slideWidth),
            (s = (i + o.options.slidesToShow - o.slideCount) * e)),
        o.slideCount <= o.options.slidesToShow && (s = o.slideOffset = 0),
        !0 === o.options.centerMode && o.slideCount <= o.options.slidesToShow
          ? (o.slideOffset =
              (o.slideWidth * Math.floor(o.options.slidesToShow)) / 2 - (o.slideWidth * o.slideCount) / 2)
      ...
      for (
        var i = this,
          ...
          s =
            !1 === i.options.infinite
              ? i.slideCount
              : ((e = -1 * i.options.slidesToScroll), (t = -1 * i.options.slidesToScroll), 2 * i.slideCount);
        e < s;
      ...
      t.$slides
        ...
        null !== t.$dots &&
          (t.$slides.not(t.$slideTrack.find('.slick-cloned')).each(function (i) {
            var e = s.indexOf(i);
            a(this).attr({ role: 'tabpanel', id: 'slick-slide' + t.instanceUid + i, tabindex: -1 }),
    ...
    (r.prototype.initDotEvents = function () {
      var i = this;
      !0 === i.options.dots &&
        (a('li', i.$dots).on('click.slick', { message: 'index' }, i.changeSlide), !0 === i.options.accessibility) &&
        ...
        !0 === s.options.centerMode
          ? ((t = s.options.slidesToShow % 2 == 0 ? 1 : 0),
            ...
            !0 === s.options.infinite &&
              ((o <= i && i <= s.slideCount - 1 - o
                ...
                : ((e = s.options.slidesToShow + i), n.slice(e - o + 1 + t, e + o + 2))
              )
                .addClass('slick-active')
                .attr('aria-hidden', 'false'),
              0 === i
                ? n.eq(n.length - 1 - s.options.slidesToShow).addClass('slick-center')
                : i === s.slideCount - 1 && n.eq(s.options.slidesToShow).addClass('slick-center')),
          ...
          : (0 <= i && i <= s.slideCount - s.options.slidesToShow
              ...
              : ((t = s.slideCount % s.options.slidesToShow),
                ...
                s.options.slidesToShow == s.options.slidesToScroll && s.slideCount - i < s.options.slidesToShow
    ...
    (r.prototype.setupInfinite = function () {
      ...
      if (
        ...
        !0 === o.options.infinite && !1 === o.options.fade && ((e = null), o.slideCount > o.options.slidesToShow))
      ) {
        for (
          t = !0 === o.options.centerMode ? o.options.slidesToShow + 1 : o.options.slidesToShow, i = o.slideCount;
          i > o.slideCount - t;
          --i
        )
          a(o.$slides[(e = i - 1)])
        ...
        (!0 === r.animating && !0 === r.options.waitForAnimate) ||
          ...
          (!1 === r.options.infinite &&
            ...
            : (r.options.autoplay && clearInterval(r.autoPlayTimer),
              ...
              r.options.asNavFor &&
                (n = (n = r.getNavTarget()).slick('getSlick')).slideCount <= n.options.slidesToShow &&
    ...
    (r.prototype.swipeDirection = function () {
      var i = this,
        ...
        t = Math.atan2(t, e);
      return ((e = (e = Math.round((180 * t) / Math.PI)) < 0 ? 360 - Math.abs(e) : e) <= 45 && 0 <= e) ||
        (e <= 360 && 315 <= e)
        ? !1 === i.options.rtl
          ? 'left'
          : 'right'
  ...
  document.addEventListener('DOMContentLoaded', function () {
    window.jQuery && jQuery.fn.slick
      ? jQuery('.featured-section__slider--init').slick({ slidesToShow: 1, slidesToScroll: 1, autoplay: !0 })
